...
<%--                        <th class="text-center">操作</th>--%>
                    ...
                    <c:forEach items="${page.list}" var="o" varStatus="status">
                        <tr>
                            ...
                            <td>${o.invoiceId}</td>
<%--                            <td><a href="${center}/cargo/contract/toView.do?id=${o.invoiceId}">${o.contractNo}</a></td>--%>
<%--                            <td>--%>
<%--                                ${o.proNum}/${o.extNum}--%>
<%--                            </td>--%>
                            <td>${o.scNo}</td>
...
<%--                            <td><fmt:formatDate value="${o.shipTime}" pattern="yyyy-MM-dd"/></td>--%>
                            ...
                            <td><c:if test="${o.state==0}">草稿</c:if>
                                <c:if test="${o.state==1}"><font color="green">已报销</font></c:if>
                                <c:if test="${o.state==2}"><font color="red">已审核</font></c:if>
                            </td>
                            <td>
