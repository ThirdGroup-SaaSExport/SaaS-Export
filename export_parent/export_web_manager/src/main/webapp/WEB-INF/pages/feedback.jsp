...
<div id="frameContent" class="content-wrapper" style="margin-left:0px;">
    ...
    <section class="content">
        ...
        <div class="panel panel-default">
            <form id="editForm" action="${ctx}/feedback/send.do" method="post">
        ...
        <div class="box-tools text-center">
            <button type="button" onclick='document.getElementById("editForm").submit()' class="btn bg-maroon">提交</button>
